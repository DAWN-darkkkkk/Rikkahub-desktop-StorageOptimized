...
async function runImageGenerationSmoke() {
  ...
  assert(stateAfter.logs.some((log: AnyRecord) => log.kind === "provider:image:edit" && log.requestPreview?.includes("reference.png")), "image edit log missing request preview");
